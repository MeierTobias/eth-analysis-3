...
\begin{align*}
    ...
    e^{-at}\sigma(t),\quad\mathfrak{Re}\{a\}>0 \;                             & \laplace\;  \frac{1}{a+2\pi if}                                                        \\
    \frac{t^{n-1}}{(n-1)!}e^{-at}\sigma(t),\quad\mathfrak{Re}\{a\}>0 \;       & \laplace\;  \frac{1}{{(a+2\pi if)}^n}                                                  \\
    e^{-a|t|},\quad\mathfrak{Re}\{a\}>0 \;                                    & \laplace\;  \frac{2a}{a^2+4\pi^2f^2}                                                   \\
    ...
    e^{-at^{2}},\quad a>0 \;                                                  & \laplace\;  \sqrt{\frac{\pi}{a}}e^{-\pi^2f^2/a}                                        \\
